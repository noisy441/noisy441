...
<p align="center">
  Системный администратор с <strong>[X] годами</strong> опыта в построении и поддержке надёжной инфраструктуры. Специализируюсь на автоматизации, мониторинге и безопасности серверных сред.
</p>
